...
vim.keymap.set('n', '<C-S-k>', [[<cmd>lua require("tmux").move_top()<cr>]], { silent = true })
vim.keymap.set('n', '<C-S-l>', [[<cmd>lua require("tmux").move_right()<cr>]], { silent = true })

vim.keymap.set('n', '<C-M-h>', [[<cmd>lua require("tmux").resize_left()<cr>]], { silent = true })
